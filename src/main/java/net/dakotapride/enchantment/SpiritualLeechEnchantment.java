...
public class SpiritualLeechEnchantment extends Enchantment {
    public SpiritualLeechEnchantment(Rarity rarity, EnchantmentTarget target, EquipmentSlot[] slotTypes) {
