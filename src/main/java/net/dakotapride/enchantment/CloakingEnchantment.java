...
public class CloakingEnchantment extends Enchantment {
    public CloakingEnchantment(Rarity rarity, EnchantmentTarget target, EquipmentSlot[] slotTypes) {
    ...
    protected boolean canAccept(Enchantment other) {
        return !(other instanceof AdriftEnchantment) && super.canAccept(other);
    }
