...
import net.dakotapride.effect.InflictionStatusEffect;
...
public class SpectreEffects {
    ...
    public static StatusEffect INFLICTION;
    ...
    public static void effects() {
        ...
        INFLICTION = Registry.register(Registries.STATUS_EFFECT, SpectreMain.createResource("infliction"),
                new InflictionStatusEffect());
    }
